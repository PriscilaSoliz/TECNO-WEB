          ...
          <div class="bg-white rounded-xl shadow p-4">
            ...
            <div class="mt-4 border-t pt-4">
              ...
              <div class="bg-gray-50 p-3 rounded-lg mb-4 text-sm">
                <p class="text-gray-900 font-medium"><i class="fas fa-user mr-2 text-gray-400"></i> {{
                  pedido.cliente?.nombre || pedido.cliente?.user?.name || 'Cliente sin nombre' }}</p>
                <p v-if="pedido.cliente?.telefono" class="text-gray-600 mt-1"><i
                    class="fas fa-phone mr-2 text-gray-400"></i> {{ pedido.cliente.telefono }}</p>
                <p v-if="pedido.cliente?.email" class="text-gray-600 mt-1"><i
                    class="fas fa-envelope mr-2 text-gray-400"></i> {{ pedido.cliente.email }}</p>
              </div>
